...
#
#
# class TestSimulationArrival(unittest.TestCase):
#     Config.params["uncertainty"]["enabled"] = False
#     Config.params["simulator"]["test_mode"] = True
#
#     def setUp(self):
#         Config.params["airport"] = "simple-arrival"
#
#     def tearDown(self):
...
#         n = 1
#         arrivals = simulation.scenario.arrivals
#         print ('length is: ', len(arrivals))
#
#         h = heapdict()
#         for arrival in arrivals:
#             h[arrival] = arrival.appear_time
#
#         for i in range(n):
#
...
#         self.assertTrue(len(arrivals), len(simulation.airport.aircrafts))
#
